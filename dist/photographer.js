...
function modalMaster(bodyTag, headerTag, mainTag, modalID) {
  ...
  function setTitleModal(modalPage, tagHTML, titleModal) {
    return (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.setInnerHtml)("#".concat(modalPage.modalID, " ").concat(tagHTML), titleModal);
  }
