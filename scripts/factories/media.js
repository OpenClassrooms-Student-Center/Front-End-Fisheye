    ...
    function mediaFactory(mediaItems){
        ...
        const photos = `assets/media/gallery/${image}`;
        const videos = `assets/media/gallery/${video}`;
        const icons = `assets/media/icons/heart-regular.svg`;
        const mediaDiv = document.querySelector('.media-div');


    // construct DOM elements
    function getUserArtDOM(){

        // let x = mediaItems.filter(isImage => image)
        // for(let i = 0; i < media.length; i++){
        //     const mediall = media[i];
        //     if(media.)
        // }
        ...
        //     images.forEach = document.createElement('img');
        // };

        // for(let i = 0; i < video.length; i++){
        //     const videos = video[i];
        //     videos.forEach = document.createElement('video');
        // };
        ...
        //         artWork.setAttribute('src', photos);
        //     }else if(video === media[i]){
        //         const artMotion = document.createElement('video');
        //         artMotion.setAttribute('src', videos);
        //     }
        // }
