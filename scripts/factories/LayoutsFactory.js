...
export class LayoutsFactory {
  ...
  getPhotographerMainDOM = (photographer, componentsFactory) => {
    ...
    const banner = componentsFactory.getPhotographerHeaderDOM(
      photographer,
      'Contactez-moi'
    );
    ...
    contactBtn.addEventListener('click', () => {
      const contactForm = componentsFactory.getContactFromDOM({
        photographerName,
      });
    ...
    photographer.medias.forEach((media, index) => {
      ...
      mediaButton.addEventListener('click', () => {
        const lightbox = componentsFactory.getLightboxDOM({
