export class ComponentsFactory {
  ...
  getSortBtnDOM = (photographerId) => {
    ...
    selected.textContent =
      ...
      window.location.search.split('&')[1].split('=')[1] !== 'Popularit%C3%A9'
    ...
    option1.textContent =
      selected.textContent === 'Date' ? 'Popularité' : 'Date';
    ...
    option2.textContent =
      selected.textContent === 'Titre' ? 'Popularité' : 'Titre';
  ...
  getImageDOM = (data, photographerName) => {
    ...
    media.setAttribute(
      'src',
      `../../assets/images/${photographerName.split(' ')[0]}/${image}`
    );
  ...
  getVideoDOM = (data, photographerName) => {
    ...
    mediaSource.setAttribute(
      'src',
      `../../assets/images/${photographerName.split(' ')[0]}/${video}`
    );
    mediaSource.setAttribute('type', 'video/mp4');
    mediaSource.textContent =
      'Désolé, votre navigateur ne peut lire cette vidéo.';
  ...
  getLightboxDOM = (data) => {
    ...
    if (medias[index].image) {
      ...
      media.setAttribute(
        'src',
        `../../assets/images/${photographerName.split(' ')[0]}/${
          medias[index].image
        }`
      );
  ...
  getContactFromDOM = (data) => {
    ...
    const firstName = this.getTextfieldDOM({
