...
function displayComponents() {
  ...
  const textfieldContainer = document.querySelector(
    '.components-container__textfield'
  );
  ...
  const avatar = componentsFactory.getAvatarDOM(
  ...
  const userLocation = componentsFactory.getUserLocationDOM(
    'Berlin, Germany',
    false
  );
  ...
  const userTagline = componentsFactory.getUserTaglineDOM(
  ...
  const media = componentsFactory.getMediaDOM(
    '../../assets/images/Marcel/Architecture_Corner_Room.jpg',
