...
async function displayHeaderData(photographerData) { //affiche le cadre des infos du photographe
    ...
    location.setAttribute("aria-label","ville et pays du photographe" + photographerData.city + ", " + photographerData.country);
    location.innerHTML = photographerData.city + ", " + photographerData.country;
...
async function initPhotographer() {
    ...
    //parfois un # se rajoute à la fin de l'adresse en tappant 'enter'
