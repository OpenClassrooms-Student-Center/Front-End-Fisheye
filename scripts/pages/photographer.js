...
//     console.log("MediasApi instance:", this.mediasApi);
//   }

//   async medias() {
//     try {
//       console.log("MediasApi URL:", this.mediasApi._url); // Assuming _url is the URL property in MediasApi
...
class PhotographerPages {
  constructor() {
    ...
    this.mediasApi = new MediasApi("/data/photographers.json");
    // this.mediasApi = new MediasApi("/datar/movie-data.json");
    // this.moviesApi = new MovieApi("/datar/movie-data.json");
  }
