        ...
        element.addEventListener('keydown', function (e) {
            ...
            */
            if (keyName === 'Tab' || keyName === 9) {
                ...
                const firstElementToFocus = firstCustomElement || firstFocusableElement
                const lastElementToFocus = lastCustomElement || lastFocusableElement

                const positionFirstElementToFocus = focusableElementsArray.indexOf(firstElementToFocus)
                const positionLastElementToFocus = focusableElementsArray.indexOf(lastElementToFocus)

                const activeElement = document.activeElement
                const positionActiveElement = focusableElementsArray.indexOf(activeElement)
